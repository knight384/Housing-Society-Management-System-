...
export const initialTickets: MaintenanceTicket[] = [
  ...
  },
  {
    ...
    speedRating: 5,
    staffRating: 5,
    feedbackComment: "Sam arrived right on time and fixed the sliding door in less than 20 minutes! Extremely polite and cleaned up afterwards.",
    feedbackTags: ["Punctual", "Fixed First Try", "Clean Cleanup", "Polite Staff"],
    feedbackDate: "2026-08-04 16:10",
    managementResponse: "Thank you Alex! We appreciate your feedback and pass on your compliments to Sam.",
    managementResponseDate: "2026-08-04 17:00",
  ...
  {
    id: "tkt-502b",
    ticketNo: "TKT-2026-064",
    unitNumber: "B-101",
    residentName: "Sarah Jenkins",
    title: "Main pipeline water pressure dropped in kitchen",
    description: "Cold water faucet pressure was low in B tower morning line.",
    category: "Plumbing",
    priority: "High",
    status: "Resolved",
    createdAt: "2026-07-28 08:30",
    resolvedAt: "2026-07-28 11:15",
    assignedStaff: "Mario PlumbWorks Co.",
    estimatedHours: 3,
    resolutionNotes: "Replaced faulty pressure regulating valve on B-101 line connection.",
    rating: 5,
    qualityRating: 5,
    speedRating: 5,
    staffRating: 4,
    feedbackComment: "Emergency response team was super quick! Arrived within 45 minutes of raising ticket.",
    feedbackTags: ["⚡ Lightning Fast", "Fixed First Try", "Great Communication"],
    feedbackDate: "2026-07-28 12:00",
    managementResponse: "Glad our rapid emergency response protocol kept your morning hassle-free!",
    managementResponseDate: "2026-07-28 14:00",
  ...
  {
    id: "tkt-502c",
    ticketNo: "TKT-2026-051",
    unitNumber: "C-204",
    residentName: "Michael Chang",
    title: "Intercom speaker crackling noise",
    description: "Gate security speaker handset has background static.",
    category: "Security",
    priority: "Low",
    status: "Resolved",
    createdAt: "2026-07-20 14:00",
    resolvedAt: "2026-07-22 17:00",
    assignedStaff: "Apex Gate Systems",
    estimatedHours: 5,
    resolutionNotes: "Re-soldered loose wiring pin in flat terminal unit.",
    rating: 4,
    qualityRating: 4,
    speedRating: 3,
    staffRating: 5,
    feedbackComment: "Technician was very thorough and polite. Took 2 days to schedule, but once here, the repair was high quality.",
    feedbackTags: ["Polite Staff", "Quality Workmanship"],
    feedbackDate: "2026-07-22 18:30",
...
export const initialDocuments: DocumentItem[] = [
  ...
  {
    id: "doc-esign-1",
    title: "Flat A-402 Registered Lease & Tenant Undertaking Agreement",
    category: "Personal Unit Locker",
    description: "Digitally executed rental registration form signed by resident Alex Rivera & tenant David Vance with verified society e-signature certification.",
    fileType: "PDF",
    fileSize: "1.6 MB",
    uploadedBy: "Alex Rivera",
    uploadedByRole: "resident",
    ...
    downloadCount: 12,
    certifiedSeal: true,
    tags: ["E-Signed", "Rental Agreement", "Tenant NOC", "Flat A-402"],
    isESigned: true,
    eFormType: "Rental Agreement & Tenant Registration",
    eSignatureData: {
      signatureType: "type",
      signatureContent: "Alex Rivera",
      signerName: "Alex Rivera",
      signerEmail: "alex.rivera@example.com",
      signerPhone: "+1 (555) 019-2831",
      signerUnit: "A-402",
      signedAt: "2026-08-01 10:14:22 UTC",
      verificationCode: "ESIGN-2026-RENT-A402-8821",
      sha256Hash: "0x8f2a41bc99d12e0e4b85c32f1a92e10476e3312f",
      ipAddress: "172.56.21.90",
      status: "Approved & Sealed",
      formFieldsSummary: {
        "Landlord Name": "Alex Rivera (Owner)",
        "Tenant Name": "David Vance",
        "Tenant Phone": "+1 (555) 234-5678",
        "Lease Duration": "12 Months (01 Aug 2026 to 31 Jul 2027)",
        "Monthly Rent": "$2,200 / month",
        "Security Deposit": "$4,400 (Escrow)",
        "Bylaws Compliance Pledge": "Agreed to no sub-letting and noise curfew hours."
      },
      reviewedBy: "Sarah Jenkins (RWA Secretary)",
      reviewedAt: "2026-08-02",
      reviewNotes: "Tenant ID verified. RWA e-seal applied."
    }
  },
  {
    id: "doc-esign-2",
    title: "Flat A-402 Heavy Furniture Move-In & Lift Reservation Request",
    category: "Personal Unit Locker",
    description: "Digital move-in clearance & elevator padding reservation form with signed damage indemnity undertaking.",
    fileType: "PDF",
    fileSize: "1.2 MB",
    uploadedBy: "Alex Rivera",
    uploadedByRole: "resident",
    ...
    downloadCount: 5,
    certifiedSeal: true,
    tags: ["E-Signed", "Move-In", "Elevator Reservation", "A-402"],
    isESigned: true,
    eFormType: "Move-In / Move-Out Request",
    eSignatureData: {
      signatureType: "draw",
      signatureContent: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='200' height='60'><path d='M20 45 Q 40 10, 60 40 T 100 30 T 140 45' stroke='%231e3a8a' stroke-width='3' fill='none'/><text x='130' y='50' font-family='cursive' font-size='14' fill='%231e3a8a'>A.Rivera</text></svg>",
      signerName: "Alex Rivera",
      signerEmail: "alex.rivera@example.com",
      signerPhone: "+1 (555) 019-2831",
      signerUnit: "A-402",
      signedAt: "2026-08-08 14:30:10 UTC",
      verificationCode: "ESIGN-2026-MOVE-A402-4011",
      sha256Hash: "0xc10f9942a1789e02341b59c7811d0232ef1a334e",
      ipAddress: "172.56.21.90",
      status: "Approved & Sealed",
      formFieldsSummary: {
        "Movement Category": "Move-In (New Tenant Arrival)",
        "Move Date": "2026-08-15",
        "Elevator Time Slot": "09:00 AM - 01:00 PM (Slot #1)",
        "Movers & Packers Vendor": "SwiftTrans Express Logistics",
        "Truck Registration": "NY-TRK-9012",
        "Elevator Caution Deposit": "$150 Refundable (Paid)"
      },
      reviewedBy: "Estate Operations Desk",
      reviewedAt: "2026-08-09",
      reviewNotes: "Lift padding scheduled for Aug 15 morning."
    }
  },
  {
    id: "doc-esign-3",
    title: "Flat B-101 Modular Kitchen Renovation & Noise Undertaking NOC",
    category: "NOC & Safety Certificates",
    description: "Digital architectural NOC & contractor noise compliance form for kitchen remodeling.",
    fileType: "PDF",
    fileSize: "1.4 MB",
    ...
    downloadCount: 3,
    certifiedSeal: false,
    tags: ["E-Signed", "Renovation NOC", "Kitchen Works", "B-101"],
    isESigned: true,
    eFormType: "Renovation & Interior NOC",
    eSignatureData: {
      signatureType: "draw",
      signatureContent: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='200' height='60'><path d='M10 30 Q 30 5, 70 35 T 120 20' stroke='%230f172a' stroke-width='3' fill='none'/><text x='110' y='45' font-family='sans-serif' font-weight='bold' font-size='12' fill='%230f172a'>S. Jenkins</text></svg>",
      signerName: "Sarah Jenkins",
      signerEmail: "sarah.j@example.com",
      signerPhone: "+1 (555) 998-1122",
      signerUnit: "B-101",
      signedAt: "2026-08-10 09:12:00 UTC",
      verificationCode: "ESIGN-2026-RENO-B101-9012",
      sha256Hash: "0x334a1b02c899e12f009d1e44a2c10928a301bf23",
      ipAddress: "192.168.1.45",
      status: "Pending Review",
      formFieldsSummary: {
        "Scope of Interior Work": "Modular Kitchen Installation & Tile Change",
        "Contractor": "UrbanCraft Design Studio",
        "Start Date": "2026-08-18",
        "Estimated Duration": "7 Working Days",
        "Working Hours Commitment": "Strictly 10 AM to 5 PM (No Sunday Drilling)",
        "Debris Disposal Plan": "Carted away daily via rear loading gate."
      }
    }
  }
];
